...
ccRSAkeysize(CCRSACryptor *cryptor) {
    return ccn_bitlen(ccrsa_ctx_n(ccrsa_ctx_public(cryptor->fk)), ccrsa_ctx_m(ccrsa_ctx_public(cryptor->fk)));
}
	...
	switch(keyType) {
		...
		case ccRSAKeyPrivate: {
            ...
            ccrsa_crt_makekey(ccrsa_ctx_zm(ccrsa_ctx_private(rsaKey->fk)), ccrsa_ctx_e(ccrsa_ctx_public(rsaKey->fk)), ccrsa_ctx_d(ccrsa_ctx_public(rsaKey->fk)),
                              ccrsa_ctx_private_zp(ccrsa_ctx_private(privk)),
                              ccrsa_ctx_private_dp(ccrsa_ctx_private(privk)), ccrsa_ctx_private_qinv(ccrsa_ctx_private(privk)),
                              ccrsa_ctx_private_zq(ccrsa_ctx_private(privk)), ccrsa_ctx_private_dq(ccrsa_ctx_private(privk)));
